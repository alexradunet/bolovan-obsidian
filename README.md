...
- **Wikilink mentions** — type `[[` in the composer to pick more notes from a ranked list, just like linking in a note. Mentions render as chips right in the input; click a chip to edit it. The paperclip button opens the same list as a fuzzy search.
